...
import { FaUserShield, FaFingerprint, FaArrowLeft, FaUser } from 'react-icons/fa'
...
const NavBtn = () => {
  const buttons = [
    { section: 'portal', icon: <FaUserShield />, label: 'My Portal' },
    { section: 'verification card', icon: <FaFingerprint />, label: 'Verification' },
    { section: 'edit', icon: <FaUser />, label: 'Edit Profile' },
  ]
  ...
  const setSection = useDashBoardContext((state) => state.setDashBoardSection)
  ...
  async function logOut() {
    ...
    const res = await axios.post(`${BASE_URL}/api/student/logout`,
    { },
    {
  ...
  return (
    ...
    >
      ...
      <div className='flex flex-col items-center mb-10 mt-4'>
        ...
        <p className='font-black text-sm uppercase tracking-widest text-green-400'>KASU Verify</p>
      </div>
